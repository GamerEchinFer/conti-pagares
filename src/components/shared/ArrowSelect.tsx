...
const ArrowSelect = () => {
  return (
    ...
    <span style={{paddingRight: "10px", cursor: "pointer"}}>
        <svg xmlns="http://www.w3.org/2000/svg" width="17.172" height="19" viewBox="0 0 17.172 19">
          <g id="SelectArrow" transform="translate(0 19) rotate(-90)">
            ...
            <path id="Trazado_357" data-name="Trazado 357" d="M4.68,8.459,0,4.229,4.68,0" transform="translate(7.267 4.444)" fill="none" stroke="#1d428a" />
          </g>
        </svg>
    </span>
  </>
