...
export const authApi = axios.create(
    {
        baseURL: process.env.NEXT_PUBLIC_API_CUSTODIA_URL+"/autenticarServicio/v1/realms/interno"
    }
);
    
export const apmApi = axios.create(
    {
        baseURL: process.env.NEXT_PUBLIC_API_CUSTODIA_URL+"/gestion-documental-interno/v1"
    }
);

export const apmApiCliente = axios.create(
    {
        baseURL: process.env.NEXT_PUBLIC_API_CUSTODIA_URL+"/interno/clientes/datos/v1"
    }
);
...
export const apmApiMsFileStream = axios.create(
    {
        baseURL: process.env.NEXT_PUBLIC_API_CUSTODIA_URL+"/ms-file-stream-manager/v1"
    }
);
